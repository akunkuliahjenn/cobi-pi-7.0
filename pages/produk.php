                        ...
                        <tr class="hover:bg-gray-50 transition duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button onclick="showDeleteModal('<?php echo htmlspecialchars($product['id']); ?>', '<?php echo htmlspecialchars($product['name']); ?>')" 
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6 mb-8">
            ...
            <form action="/process/simpan_produk.php" method="POST">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button type="button" class="hidden inline-flex items-center px-6 py-3 border border-gray-300 text-base font-medium rounded-lg shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition duration-200" id="cancel_edit_button" onclick="resetForm()">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 transform scale-95 transition-all duration-200">
        <div class="p-6">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900" id="modal-title">Hapus Produk</h3>
                    <p class="text-sm text-gray-600" id="delete-message">Apakah Anda yakin ingin menghapus produk ini?</p>
                </div>
            </div>
